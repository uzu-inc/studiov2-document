...
개선 방법\* 라이트의 조건을 「단계１이 진행 중」으로 바꾼다

* 라이트의 조건을 「단계１이 시작했으며 단계２가 밟히지 않았다」로 바꾼다
