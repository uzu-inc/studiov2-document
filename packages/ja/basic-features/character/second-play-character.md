...
<summary>「2周目＋」を設定したキャラクターにおいて、初回は有料、2回目以降は無料という設定は可能か？</summary>

プレイ回数を参照して料金を出し分ける機能はございません。通常キャラクターと「2周目＋」キャラクターといったキャラクター種別による料金設定のみとなります。

「2周目＋」キャラクターの料金を有料にするとプレイごとに都度有料、無料にすると初回からずっと無料になります。
