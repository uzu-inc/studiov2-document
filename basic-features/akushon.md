...
<table><thead><tr><th width="141">名称</th><th>内容</th></tr></thead><tbody><tr><td>シンプル</td><td>「実行する」を押すだけでアクションが発動する</td></tr><tr><td>パスワード</td><td>「実行する」を押すとパスワード入力が求められ、正しいパスワードを入力するとアクションが発動する</td></tr></tbody></table>
...
* **アクションの実行条件**：キャラクターの制限だけであればチェックボックスで簡単にできます。その他細かい条件を設定したい場合は「[**高度な設定**](akushon.md#na)」を利用してください。
...
配置できるのは、「手がかりの中」と「基本フェーズの中」の2ヶ所です。ここでは「基本フェーズの中」に配置する場合を説明します。
